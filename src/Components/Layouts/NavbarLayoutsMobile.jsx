...
const NavbarLayoutsMobile = (props) => {
  ...
  return (
    <div className="w-full h-12 bg-bgcolorcardnavbar-500 flex justify-center items-center gap-x-10">
      <Link to="/">
        <i className={titleNavbar === "home" ? "fa fa-home fa-xl text-white" : "fa fa-home fa-xl"}></i>
      </Link>
      ...
      <Link to="/todolist">
        <i className={titleNavbar === "todolist" ? "fa fa-calendar-days fa-xl text-white" : "fa fa-calendar-days fa-xl"}></i>
      </Link>
    </div>
  );
};
