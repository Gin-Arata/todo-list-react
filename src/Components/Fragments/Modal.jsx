...
const Modal = (props) => {
  ...
  return (
    <>
      {isOpen && (
        <div
          className="absolute inset-0 rounded-lg bg-black bg-opacity-50 z-50 flex justify-center items-center"
            ...
            <div className="max-w-full min-h-8 bg-slate-700 flex items-center">
              <div className="flex justify-between items-center px-4">
                <div className="flex items-center">
                  <div
                    className="w-4 h-4 bg-red-500 rounded-full mr-2 cursor-pointer"
                    onClick={closeModal}
                  ></div>
